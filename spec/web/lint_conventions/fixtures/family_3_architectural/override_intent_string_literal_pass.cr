...
# text `override_intent :foo, :bogus` (a SHAPE that would otherwise
...
class StringLiteralScreen < UI::Screen
  ERROR_MESSAGE = "use override_intent :swipe_actions, :bogus_widget — and yes a class constant is required"
