...
module BrandKit
  ...
  def self.generate_html : String
    ...
    String.build do |html|
      ...
      <head>
        ...
        <title>Amber V2 — Brand Kit &amp; Accessibility Showcase</title>
        <style>
      #{css}
      ...
      html << <<-HEADER
          <header style="margin-bottom: 3rem;">
            <div style="display: flex; align-items: flex-start; justify-content: space-between; flex-wrap: wrap; gap: 1rem;">
              <div>
                <h1 style="font-size: 2rem; font-weight: 800; margin-bottom: 0.25rem;">Amber V2 Brand Kit</h1>
      ...
      html << <<-FOOTER
          <footer style="margin-top: 4rem; padding-top: 2rem; border-top: 1px solid light-dark(var(--color-gray-200), var(--color-gray-700)); font-size: 0.75rem; color: light-dark(var(--color-gray-400), var(--color-gray-500));">
            <p>Generated by Amber V2 Asset Pipeline CSS Engine. All styles above are produced by the engine — no external CSS.</p>
          </footer>
        </div>
      </body>
      </html>
    ...
    String.build do |s|
      ...
      [{"font-thin", "100"}, {"font-light", "300"}, {"font-normal", "400"},
       ...
       {"font-extrabold", "800"}, {"font-black", "900"}].each do |name, weight|
        ...
        s << %(<span style="font-weight: #{weight};">Amber V2 Framework</span>\n)
        s << %(</div>\n)
      end
  ...
  def self.modern_layout_section : String
    String.build do |s|
      ...
      s << %(<p style="font-size: 0.875rem; line-height: 1.6;">Amber V2 uses modern CSS features to create elegant, accessible web applications. The framework leverages native browser capabilities to reduce JavaScript complexity while maintaining a rich user experience across devices.</p>\n)
      s << %(</div>\n)
      s << %(<div class="demo-box">\n)
      s << %(<p class="a11y-label">text-wrap: pretty</p>\n)
      s << %(<p style="font-size: 0.875rem; line-height: 1.6; text-wrap: pretty;">Amber V2 uses modern CSS features to create elegant, accessible web applications. The framework leverages native browser capabilities to reduce JavaScript complexity while maintaining a rich user experience across devices.</p>\n)
      s << %(</div>\n)
      s << %(</div>\n)
  ...
  def self.dialog_popover_section : String
    String.build do |s|
      ...
      [{"What is Amber V2?", "Amber V2 is a complete rewrite of the Amber web framework for Crystal. It ships as a monorepo with zero runtime dependencies, uses ECR templates exclusively, and targets WCAG 2.2 AA accessibility compliance."},
       {"Why no JavaScript frameworks?", "Amber V2 uses native HTML/CSS features and minimal Stimulus controllers instead of heavy JavaScript frameworks. Features like <code>&lt;dialog&gt;</code>, the Popover API, and <code>&lt;details&gt;</code> provide rich interactivity natively."},
