...
|---|---|---|---|---|---|
| 1 | Design Token Foundation | Not Started | — | — | Android generator deferred per `handoff/phase-01-architect-scope-deferral-2026-05-20.md`; canonical-palette tolerance tightened to ΔE2000 ≤ 1.0 |
