...
| 7 | CI Integration for Accessibility & Visual Verification | Not Started — depends on 6.5 + 6 + 6.8 | — | — | Re-scoped 2026-05-22: was "build audit infrastructure" (now in 6.5); rescoped to "integrate Phase 6.5's harness into GitHub Actions CI; run on every PR." Now also wraps Phase 6.8's polished baselines. |
