...
| 3 | SwiftUI Native Bridge | Dispatch C Implementer Active — Group 3 container widgets (2026-05-20) | Foundation: `7756d25 6996ba7`; Dispatch A: `7486040 ed51fd7 dfe1274 bdfcf18`; Dispatch B: `3a81950 34e1d4b` | — | Owner decisions: (α) layout primitives Spacer/VStack/HStack/ZStack/ScrollView stay native — excluded from Phase 3 scope; (II) Dispatch C scoped to Group 3 container widgets only (NavigationStack, NavigationLink, NavigationSplitView, TabView, Toolbar, Sheet, Popover, Alert, ConfirmationDialog, Form, Grid, Card, Surface, MenuButton, ToggleButton — 15 widgets needing APSKHostedChild representable pattern for Crystal-built children inside SwiftUI parents). Validator runs after Dispatch C; Groups 4–6 dispatched separately if needed |
