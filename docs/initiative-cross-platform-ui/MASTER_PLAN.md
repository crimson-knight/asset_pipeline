...
| 3 | SwiftUI Native Bridge | **Dispatch B returned (2026-05-20)** — 20/34 widgets shipped; layout-primitive question + Dispatch C decision pending | Foundation: `7756d25 6996ba7`; Dispatch A: `7486040 ed51fd7 dfe1274 bdfcf18`; Dispatch B: `3a81950 34e1d4b` | — | Groups 1+2 complete: 21 new Swift Override + 21 new Facade classes + 21 Populator methods + 20 visit-method migrations in BOTH renderers. ~1500 net lines deleted across both renderers. 65 specs passing (41 prior + 24 new). Deferred per Implementer judgment: Spacer (and likely VStack/HStack/ZStack/ScrollView for Dispatch C) are layout primitives that the project's North Star says stay native. Text/color `on_change` callbacks stubbed (numeric payload only) — explicitly deferred to Phase 5 follow-up. Remaining 14 widgets in Groups 3–6 awaiting architect call on layout-primitive scope before Dispatch C |
